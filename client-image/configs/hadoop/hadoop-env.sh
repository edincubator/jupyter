      ...
      export HDFS_NAMENODE_OPTS="$HDFS_NAMENODE_OPTS -Djava.security.auth.login.config=/opt/hadoop/etc/hadoop/hdfs_nn_jaas.conf -Djavax.security.auth.useSubjectCredsOnly=false"
      export HDFS_SECONDARYNAMENODE_OPTS="$HDFS_SECONDARYNAMENODE_OPTS -Djava.security.auth.login.config=/opt/hadoop/etc/hadoop/hdfs_nn_jaas.conf -Djavax.security.auth.useSubjectCredsOnly=false"
      export HDFS_DATANODE_OPTS="$HDFS_DATANODE_OPTS -Djava.security.auth.login.config=/opt/hadoop/etc/hadoop/hdfs_dn_jaas.conf -Djavax.security.auth.useSubjectCredsOnly=false"
      export HADOOP_JOURNALNODE_OPTS="$HADOOP_JOURNALNODE_OPTS -Djava.security.auth.login.config=/opt/hadoop/etc/hadoop/hdfs_jn_jaas.conf -Djavax.security.auth.useSubjectCredsOnly=false"
      ...
      export JAVA_LIBRARY_PATH=${JAVA_LIBRARY_PATH}:/opt/hadoop/lib/native/Linux--64
